...
qvals <- qvalue(pval)
spark62$adjustedPval <- qvals$qvalues

#filtro para quedarme con los significativos
data_frame <- as.data.frame(spark62)
...
spe_filtered <- spe6[genes_to_keep, ]
...
pal <- c("darkorange", "magenta", "yellow","green", "darkblue","darkgreen")
