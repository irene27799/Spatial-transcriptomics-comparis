...
qvals <- qvalue(pval)
spark32$adjustedPval <- qvals$qvalues

#filtro para quedarme con los significativos
data_frame <- as.data.frame(spark32)
...
spe_filtered <- spe3[genes_to_keep, ]
...
pal <- c("magenta", "darkblue", "yellow","green", "darkgreen","darkorange")
