...
qvals <- qvalue(pval)
spark22$adjustedPval <- qvals$qvalues

#filtro para quedarme con los significativos
data_frame <- as.data.frame(spark22)
...
spe_filtered <- spe2[genes_to_keep, ]
...
pal <- c("darkblue", "magenta", "green","yellow", "darkgreen","darkorange")
